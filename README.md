...
```bash
uvx --from https://github.com/champi-ai/champi-stt/releases/download/v1.3.1/champi_stt-1.3.1-py3-none-any.whl champi-stt --help
```
...
```toml
[tool.uv.sources]
champi-stt = { url = "https://github.com/champi-ai/champi-stt/releases/download/v1.3.1/champi_stt-1.3.1-py3-none-any.whl" }
```
...
```bash
uvx --from "champi-stt[mcp] @ https://github.com/champi-ai/champi-stt/releases/download/v1.3.1/champi_stt-1.3.1-py3-none-any.whl" champi-stt mcp serve
```

Or install permanently with the `mcp` extra:

```bash
uv pip install "https://github.com/champi-ai/champi-stt/releases/download/v1.3.1/champi_stt-1.3.1-py3-none-any.whl[mcp]"
...
```json
{
  "mcpServers": {
    "champi-stt": {
      ...
      "args": [
        "--from",
        "champi-stt[mcp] @ https://github.com/champi-ai/champi-stt/releases/download/v1.3.1/champi_stt-1.3.1-py3-none-any.whl",
        "champi-stt",
        "mcp",
        "serve"
      ]
