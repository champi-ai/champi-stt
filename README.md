...
```bash
uvx --from https://github.com/champi-ai/champi-stt/releases/download/v1.1.0/champi_stt-1.1.0-py3-none-any.whl champi-stt --help
```
...
```toml
[tool.uv.sources]
champi-stt = { url = "https://github.com/champi-ai/champi-stt/releases/download/v1.1.0/champi_stt-1.1.0-py3-none-any.whl" }
```
